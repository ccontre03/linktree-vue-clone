...
<!-- Header -->
 <div class="mb-6 flex flex-col items-center text-center sm:flex-row sm:text-left">
  <div class=",mb-4 h-20 w-20 shrink-0 overflow-hidden rounded-full border-4 border-green-400 sm:mr-6 sm:mb-0">
  <img 
    :src="bio.avatar"
    :alt="bio.name"
...
<!-- About Section -->
 ...
 <!-- Skills Section -->
  ...
  <!-- Contact -->
   <div>
      <h2 class="mb-3 text-lg font-semibold text-white">Getting in Touch</h2>
      <a :href="`mailto:${bio.email}`"
        class="group inline-flex items-center gap-2 rounded-xl bg-green-500 px-6 py-3 font=medium text-white shadow-lg shadow-green-500/30 trasnistion-all duration-200 hover:scale-105 hover:bg-green-600 hover:shadow-xl hover:shadow-green-500/40 active:scale-95">
        <svg 
        data-slot="icon" 
        aria-hidden="true" 
        fill="none" 
